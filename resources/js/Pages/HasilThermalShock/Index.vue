                    ...
                    <Table>
                        <TableHeader>
                            <TableRow class="bg-muted/50 text-xs">
                                ...
                                <TableHead class="text-center">Metode Biasa</TableHead>
                                ...
                                <TableHead class="text-center">Visual</TableHead>
                        ...
                        <TableBody>
                            ...
                            <TableRow v-for="item in props.hasil.data" :key="item.id" class="hover:bg-muted/30 text-xs">
                                ...
                                <TableCell class="text-center font-mono">{{ parseFloat(item.metode_biasa).toFixed(2) }}</TableCell>
                                ...
                                <TableCell class="text-center">{{ item.visual }}</TableCell>
                                <TableCell class="text-center whitespace-nowrap">
