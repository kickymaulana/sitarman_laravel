            ...
            <CardContent>
                ...
                >
                    <p class="text-xs text-muted-foreground italic font-medium">
                        Menampilkan {{ ovens.from ?? 0 }} -
                        {{ ovens.to ?? 0 }} dari {{ ovens.total }} data oven
                    </p>
