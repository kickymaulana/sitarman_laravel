...
const props = defineProps<{ 
    spesifikasi: { id: number; spesifikasi: string };
}>();

const form = useForm({ 
    spesifikasi: props.spesifikasi.spesifikasi 
});
</script>

<template>
    <Head title="Edit Spesifikasi" />
    <div class="flex flex-col gap-6 p-4 md:p-8 pt-1">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-4">
                ...
                ></Button>
                <h2 class="text-3xl font-bold tracking-tight">Edit Spesifikasi</h2>
            </div>
        </div>
        <div class="max-w-2xl">
            <Card class="border-none shadow-lg">
                        ...
                        <AlertDialogContent>
                            <AlertDialogHeader
                                ...
                                ><AlertDialogDescription
                                    ...
                                    <strong>{{ props.spesifikasi.spesifikasi }}</strong>?</AlertDialogDescription
                                ></AlertDialogHeader
                            >
                            <AlertDialogFooter
                ...
                <CardContent class="pt-6">
                    <form
                        @submit.prevent="
                            form.put(route('spesifikasi.update', props.spesifikasi.id))
                        "
                        class="space-y-6"
                    >
