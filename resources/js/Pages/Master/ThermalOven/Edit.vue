...
const props = defineProps<{ 
    thermaloven: { id: number; thermal_oven: string };
}>();

const form = useForm({ 
    thermal_oven: props.thermaloven.thermal_oven 
});
</script>

<template>
    <Head title="Edit Thermal Oven" />
    <div class="flex flex-col gap-6 p-4 md:p-8 pt-1">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-4">
                ...
                ></Button>
                <h2 class="text-3xl font-bold tracking-tight">Edit Thermal Oven</h2>
            </div>
        </div>
        <div class="max-w-2xl">
            <Card class="border-none shadow-lg">
                    ...
                    <AlertDialog>
                        ...
                        <AlertDialogContent>
                            <AlertDialogHeader
                                ...
                                ><AlertDialogDescription
                                    >Hapus permanen thermal oven
                                    <strong>{{ props.thermaloven.thermal_oven }}</strong>?</AlertDialogDescription
                                ></AlertDialogHeader
                            >
                            <AlertDialogFooter
                ...
                <CardContent class="pt-6">
                    <form
                        @submit.prevent="
                            form.put(route('thermaloven.update', props.thermaloven.id))
                        "
                        class="space-y-6"
                    >
