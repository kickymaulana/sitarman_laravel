...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('thermal_shock', function (Blueprint $table) {
            ...
            $table->integer('suhu_display_200')->nullable()->default(0);
            $table->integer('suhu_actual_180')->default(0);
            $table->integer('suhu_actual_200')->nullable()->default(0);
            $table->time('jam_awal_proses_180')->default('00:00:00');
            $table->time('jam_awal_proses_200')->nullable()->default('00:00:00');
            $table->time('jam_capai_suhu_180')->default('00:00:00');
            $table->time('jam_capai_suhu_200')->nullable()->default('00:00:00');
            $table->integer('suhu_awal_180')->default(0);
            $table->integer('suhu_awal_200')->nullable()->default(0);
            $table->string('suhu_air_180')->default('-');
            $table->string('suhu_air_200')->nullable()->default('-');
            $table->time('jam_mulai_tembak_180')->default('00:00:00');
            $table->time('jam_mulai_tembak_200')->nullable()->default('00:00:00');
            $table->time('jam_selesai_tembak_180')->default('00:00:00');
            $table->time('jam_selesai_tembak_200')->nullable()->default('00:00:00');
